...
public:
    ...
    void setupUi(QWidget *AddressBookPage)
    {
        ...
        AddressBookPage->resize(895, 380);
    ...
    void retranslateUi(QWidget *AddressBookPage)
    {
        ...
        labelExplanation->setText(QApplication::translate("AddressBookPage", "These are your Bitcoin-sCrypt addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you and avoid re-using addresses.", 0, QApplication::UnicodeUTF8));
...
#ifndef QT_NO_TOOLTIP
        signMessage->setToolTip(QApplication::translate("AddressBookPage", "Sign a message to prove you own a Bitcoin-sCrypt address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        signMessage->setText(QApplication::translate("AddressBookPage", "&Sign Message", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        verifyMessage->setToolTip(QApplication::translate("AddressBookPage", "Verify a message to ensure it was signed with a specified Bitcoin-sCrypt address", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
